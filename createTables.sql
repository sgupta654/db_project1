...
CREATE OR REPLACE TRIGGER message_id_increment 
...
/*  NAME 				TYPE			NULL?		*/
	...
	FOREIGN KEY (USER_ID) REFERENCES USERS ON DELETE CASCADE,
	CONSTRAINT CONFIRM_STATUS_VALS CHECK ((CONFIRMATION = 'ATTENDING') OR (CONFIRMATION = 'DECLINED') OR (CONFIRMATION = 'UNSURE') OR (CONFIRMATION = 'NOT-REPLIED'))
);
