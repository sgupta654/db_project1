...
INSERT INTO EDUCATION (USER_ID, PROGRAM_ID, PROGRAM_YEAR)
	(SELECT keykholt.PUBLIC_USER_INFORMATION.USER_ID, PROGRAMS.PROGRAM_ID, keykholt.PUBLIC_USER_INFORMATION.PROGRAM_YEAR 
		FROM keykholt.PUBLIC_USER_INFORMATION PUB_USER_INFO
		RIGHT JOIN PROGRAMS
...
INSERT INTO USER_EVENTS (EVENT_ID, EVENT_CREATOR_ID, EVENT_NAME, EVENT_TAGLINE, 
	EVENT_DESCRIPTION, EVENT_HOST, EVENT_HOST, EVENT_TYPE, EVENT_SUBTYPE, EVENT_LOCATION,
	EVENT_CITY_ID, EVENT_START_TIME, EVENT_START_TIME, EVENT_END_TIME)
	(SELECT PUB_EV_INFO.EVENT_ID, PUB_EV_INFO.EVENT_CREATOR_ID, PUB_EV_INFO.EVENT_NAME, PUB_EV_INFO.EVENT_TAGLINE, 
	PUB_EV_INFO.EVENT_DESCRIPTION, PUB_EV_INFO.EVENT_HOST, PUB_EV_INFO.EVENT_HOST, PUB_EV_INFO.EVENT_TYPE, 
	PUB_EV_INFO.EVENT_SUBTYPE, PUB_EV_INFO.EVENT_LOCATION, CITIES.EVENT_CITY_ID, PUB_EV_INFO.EVENT_START_TIME, 
	PUB_EV_INFO.EVENT_START_TIME, PUB_EV_INFO.EVENT_END_TIME)
		FROM keykholt.PUBLIC_EVENT_INFORMATION PUB_EV_INFO
		RIGHT JOIN CITIES
		ON PUB_EV_INFO.CITY = CITIES.CITY_NAME
		AND PUB_EV_INFO.STATE = CITIES.STATE_NAME
		AND PUB_EV_INFO.COUNTRY = CITIES.COUNTRY_NAME
